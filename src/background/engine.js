 ...
 */
export async function generateSocraticResponse(userMessage, context = "", imageData = null) {
    try {
        ...
        console.log(`[Diagnostic] Calling Model: ${CONFIG.MODEL_ID} (Multimodal: ${!!imageData})`);
